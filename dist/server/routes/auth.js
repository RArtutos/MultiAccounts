...
router.post('/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, _a, email, password, user, _b, token;
...
router.post('/register', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, _a, email, password, name, existingUser, hashedPassword, now, user, token;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                result = registerSchema.safeParse(req.body);
                if (!result.success) {
                    return [2 /*return*/, res.status(400).json({ errors: result.error.errors })];
                }
                _a = result.data, email = _a.email, password = _a.password, name = _a.name;
